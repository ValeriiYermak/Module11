"""Реалізуйте для класу Vector операцію скалярного добутку векторів. Тобто перевизначте для нього 
математичний оператор __mul__
...
class Vector:
    ...
    def __mul__(self, vector):
        return(x = self.coordinates.x * vector.coordinates.x + y = self.coordinates.y * vector.coordinates.y)
